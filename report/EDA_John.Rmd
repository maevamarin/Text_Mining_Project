...
#Tokenization
boris.tok<-unnest_tokens(boris,output = "word",input = "Text",to_lower = TRUE,strip_punct=TRUE,strip_numeric=TRUE)
...
## Lexical Diversity
A diversity index is a measure of richness of a text
