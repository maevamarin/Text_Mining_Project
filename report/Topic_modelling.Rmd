...
\@ref(tab:table-term-macron)
\@ref(tab:table-features-macron)

```{r table-term-macron,warning=FALSE}
...
\@ref(tab:table-term-combine)

```{r table-term-combine,warning=FALSE}

terms_combine<-terms(lda_combine,6)
terms_combine<-data.frame(terms_combine)
